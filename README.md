...
* **BitBucket Link:** <https://bitbucket.org/toarnabtrainer/aec_ml_mca_feb_2026/src/main/> or <https://tinyurl.com/htjbb2m9>
...
## 🔶 Last Year's Project Presentation Schedule:
- ✅ **5th May 2025 (Monday) from 10 am to 1 pm for Project Group Numbers 1 to 6.**
- ✅ **5th May 2025 (Monday) from 3 pm to 6 pm for Project Group Numbers 7 to 13.**

## 🔶 Last Year's Important points to remember regarding Project Presentation:
- 🔰 In the project presentation, students should ensure stable internet connectivity, working microphone and camera for their laptops, proper college uniform and system ready with project presentation and execution.<br>
...
- 🔰 Project presentation PPT should have 15 to 16 slides with no program code inclusion.<br>
...
- 🔰 Project Presentation Slots has been shared in here in this BitBicket account, check it carefully and make yourself available accordingly.<br>
...
- 🔰 I wish you all my best wishes to you for a successful project presentation.<br>
...
![52895335-6d32-415b-bc2f-42e88bda388b](https://github.com/user-attachments/assets/19dddc1d-3ca9-4e22-ae7d-515142e0a13f)
...
* **MS-Office 2007:** https://edu.gcfglobal.org/en/topics/office2007/ <br>
* **MS-Office 2010:** https://edu.gcfglobal.org/en/topics/office2010/ <br>
* **MS-Office 2013:** https://edu.gcfglobal.org/en/topics/office2013/ <br>
* **MS-Office 2016:** https://edu.gcfglobal.org/en/topics/office2016/ <br>
* **MS-Excel Formulas:** https://edu.gcfglobal.org/en/excelformulas/ <br>
* **50 Tips to Master Excel ebook:** https://drive.google.com/file/d/0ByEvd0vhZtF3Zm9tY09YNWpuUnM/view <br>
* **How to remove password from an Excel Worksheet:** https://www.youtube.com/watch?v=fsVb6id97_E&list=PLmkaw6oRnRv9uEamCt-PXS-bP-rmoxcLc&index=3 <br>
* **MS-Excel Cheat Sheet:**	https://drive.google.com/file/d/1dGDoOiIhFFD71FxUxMO-ZYYE2UYLNGhR/view?usp=sharing <br>

<hr>


**☑️ 9 Different Distance Measure Techniques:** https://towardsdatascience.com/9-distance-measures-in-data-science-918109d069fa <br>
**☑️ Elite Data Science Tutorial:** https://elitedatascience.com/primer <br>
**☑️ Hierarchical Clustering Explained:** https://towardsdatascience.com/hierarchical-clustering-explained-e59b13846da8 <br>
**☑️ ML and Statistical Analysis Lab Setup:** <https://datatab.net/> <br>
**☑️ Scikit Learn Official Site for User Guide:** <https://scikit-learn.org/stable/user_guide.html> <br>
**☑️ Streamlit Playground:** <https://streamlit.io/playground> <br>
**☑️ Markown Cheat Sheet:** <https://www.markdownguide.org/cheat-sheet/> <br>
**☑️ Lots of Books on Data Science, Machine Learning, Deep Learning, Python and R:** <https://github.com/linux08/machine-learning-books/blob/master/Fundamentals%20of%20Machine%20Learning%20for%20Predictive%20Data%20Analytics%202015.pdf> <br>
...
For ML projects, **Statista** is useful if we are working on:
...
Some of the properties of lambda functions in Python programming include: <br>
* **Anonymous:** Lambda functions are anonymous, meaning they do not have a name like regular functions. They are defined using the keyword "lambda" followed by the arguments and the expression. <br>
* **Single Expression:** A lambda function can only contain a single expression that is evaluated and returned as the function result. This means that it cannot contain multiple statements or control flow structures. <br>
* **Concise:** Lambda functions are concise and can be defined in a single line of code. This makes them useful for defining simple functions on-the-fly. <br>
* **Immutable:** Lambda functions are immutable, meaning they cannot be modified once defined. This means that you cannot change the behavior of a lambda function after it has been defined. <br>
* **Higher-order Functions:** Lambda functions are often used in combination with higher-order functions such as map(), filter(), and reduce(). These functions take other functions as arguments and return new functions as results. <br>
* **Memory-efficient:** Lambda functions are memory-efficient since they are defined on-the-fly and do not require a separate function definition. This can be useful when working with large data sets or when memory usage is a concern. <br>
* **One-Liners:** Lambda functions are often used for simple, one-liner operations such as filtering, sorting, or mapping data. <br>
* **Functional Programming:** Lambda functions are a key feature of functional programming in Python, allowing for higher-order functions and other functional programming techniques. <br>
* **Variables:** Lambda functions can use variables from the enclosing scope, which can be useful in some cases. However, this can lead to unexpected behavior if not used carefully. <br>
